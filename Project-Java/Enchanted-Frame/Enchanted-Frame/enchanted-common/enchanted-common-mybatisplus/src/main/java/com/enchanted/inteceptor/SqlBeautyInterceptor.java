package com.enchanted.inteceptor;
 ...
 * @Description: TODO: MyBatis插件: SQL日志：SQL： [ INSERT INTO user ( name, age, create_by, create_time, delete_flag, version ) VALUES ( "xmm3", 18, "Summerday", Tue Nov 14 06:58:38 CST 2023, 0, 0 ) ]执行耗时[ 51ms ]
 * @PackageName:com.enchanted.inteceptor
 * @Author Enchanted
 * @Date 2023/11/14 06:53
 * @Version 1.0
 */
@Intercepts(value = {
